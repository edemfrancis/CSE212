...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                // Reuse RemoveHead and RemoveTail for edge cases
                if (curr == _head)
                {
                    RemoveHead();
                }
                ...
                // For middle nodes, reconnect the links to remove
                else
                {
    ...
    {
        // Search for all nodes containing 'oldValue' and replace with 'newValue'
        // Continue traversal (no early return)
        Node? curr = _head;
        while (curr is not null)
        {
